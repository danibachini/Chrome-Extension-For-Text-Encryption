            ...
            <div className='container text-lg text-black h-[37.5rem] w-[50rem] p-4 bg-slate-50'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='grid grid-cols-3'>
                        ...
                        />
                        {/* add something like 'we suggest encrypting/decrypting small chunks of text as a long text 
                        can take several minutes to encrypt/decrypt depending on your internet connexion' */}
                    </div>
